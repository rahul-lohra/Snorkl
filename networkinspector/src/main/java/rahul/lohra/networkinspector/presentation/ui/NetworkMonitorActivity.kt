...
import rahul.lohra.networkinspector.presentation.viewmodel.NetworkMonitorViewmodel
...
import rahul.lohra.networkinspector.data.local.db.NetworkDatabase
import rahul.lohra.networkinspector.data.repository.NetworkRepositoryImpl
import rahul.lohra.networkinspector.domain.usecas.GetPagedNetworkLogsUseCase
import rahul.lohra.networkinspector.presentation.data.UiFail
import rahul.lohra.networkinspector.presentation.data.UiInitial
import rahul.lohra.networkinspector.presentation.data.UiLoading
...
import rahul.lohra.networkinspector.presentation.viewmodel.NetworkMonitorViewmodelFactory

class NetworkMonitorActivity: ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val db = Room.databaseBuilder(applicationContext, NetworkDatabase::class.java, "network_log_db")
            .build()
